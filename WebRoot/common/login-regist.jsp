...
<form id="loginform" class="loginform" method="post" action="LoginServlet?method=loginf" >
...
<div class="dialog-body"> 
<form id="registform" class="registform" method="post" action="MemberServlet?method=add3" onsubmit="return formcheck(this)">
<input class="input" id="role" value="2" name="roles" size="30"  type="hidden">
  <div class="form-group">
    <div class="field field-icon">
	  <span class="icon icon-user"></span>
      <input class="input" id="username" name="username" size="30"  data-validate="required:必填,length#>=4:4-20位字符,length#<=20:4-20位字符,username:英文字母开头的字母、下划线、数字组合,ajax#UserServlet?method=approvalusername&username=:用户已注册" placeholder="请输入账号" type="text">
