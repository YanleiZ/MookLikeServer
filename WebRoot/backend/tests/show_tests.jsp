...
<div id="formwrapper">
	<h3>查看课程测试</h3>
	<form action="TestsServlet?method=update&pageNo=${page.pageNo }&pageSize=${page.pageSize }" method="post">
	...
	<fieldset>
		...
		<div>
			...
			<input type="text" name="name" id="name" value="${tests.name }" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
			<label for="settime">上传时间</label>
			<input type="text" name="settime" id="settime" value="${tests.settime }" size="8" maxlength="200" /> 
			<br />	
		</div>
<div>
			...
			<select name="course" id="courseIds" >
				...
				<option value="${s.id }"  <c:if test="${s.id eq tests.course.id }">selected="selected"</c:if>
				>${s.name}</option>
				</c:forEach>
			</select> 
		</div>
		<div>
			...
			<input type="text" name="descp" id="descp" value="${tests.descp }" size="60" maxlength="200" /> 
			<br />	
		</div>
		<div>
			<label for="timucontent">题目</label>
			<div style="margin:0px 0px 0px 130px;">
			<textarea rows="10" cols="100" name="timucontent" id="timucontent" >${tests.timucontent }</textarea>
			</div>
			<br />	
		</div>
		<div>
		...
		<div>
			...
			<div style="margin:0px 0px 0px 130px;">
			<textarea rows="10" cols="100" name="daancontent" id="daancontent" >${tests.daancontent }</textarea>
			</div>
			<br />	
		</div>
		<div>
