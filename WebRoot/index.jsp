...
<div class="container">
	  ...
	  <% i = 1; %>
	      ...
	      <a href="javascript:void(0)">专业课程</a> 
	      </div>
	      <br>
	      <br>
	      ...
	      <%if(i<=36){ %>
 		  <%i++; %>
		      <div class="xl2" style="margin-bottom:10px">
			      <div class="xl12" style="height:130px">
			      <a href="IndexServlet?method=course&id=${s.id}"><img alt="" src="upload_image/${s.img }" width="100%" ></a>
			      </div>
			      <div class="xl12"style="margin-top:10px;max-height:40px;overflow:hidden;text-align:center">
			      	 <a href="IndexServlet?method=course&id=${s.id } ">${s.name }</a>
			      </div>
		      </div>
	       <%} %>
	      </c:forEach>
